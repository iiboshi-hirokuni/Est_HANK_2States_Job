...
figure('Name','FP Shock');

subplot(3,3,1);
hold on;
plot(vTime,J2.FP_shock,'linewidth',1.5,'linestyle',line_style,'color',color);
set(gcf,'color','w');
title('Fiscal Policy Shock','interpreter','latex','fontsize',14);
...
if data_country == 1
  save('IRF_FP_JP_J2.mat','J2');
else
   save('IRF_FP_US_J2.mat','J2'); 
end    
